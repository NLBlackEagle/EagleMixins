...
import eaglemixins.item.ItemExampleArmor;
import eaglemixins.potion.PotionExample;
import eaglemixins.recipe.RecipeExample;

@Mod.EventBusSubscriber(modid = EagleMixins.MODID)
public class ModRegistry {

        public static ItemArmor.ArmorMaterial EXAMPLE_ARMOR = EnumHelper.addArmorMaterial("example_armor", EagleMixins.MODID + ":example_armor", 26, new int[]{2,4,6,2}, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0.0F);
        ...
        public static PotionType examplePotion = new PotionType("example", new PotionEffect(PotionExample.INSTANCE)).setRegistryName(new ResourceLocation(EagleMixins.MODID, "example"));
        ...
        public static void registerRecipeEvent(RegistryEvent.Register<IRecipe> event) {
                event.getRegistry().register(new RecipeExample().setRegistryName(new ResourceLocation(EagleMixins.MODID, "example")));
        }
